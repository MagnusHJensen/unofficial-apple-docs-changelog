...
- **Type:** `StatusContentCacheStatusContentCacheStatusObject`
- **Required:** Yes
...
- [StatusContentCacheStatusContentCacheStatusObject](/documentation/devicemanagement/statuscontentcachestatuscontentcachestatusobject) - The basic set of AssetCache status items
