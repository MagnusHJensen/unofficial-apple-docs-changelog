...
- **Type:** `NetworkVPNIKEV2Proxies_ProtocolObject`
- **Required:** No
...
- [NetworkVPNIKEV2Proxies_ProtocolObject](/documentation/devicemanagement/networkvpnikev2proxies_protocolobject) - The dictionary to use to configure HTTP servers  for `Proxies` for use with `VPN`.
