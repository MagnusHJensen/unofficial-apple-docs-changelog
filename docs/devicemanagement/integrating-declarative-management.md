...
The device management service enables declarative management by sending a [DeclarativeManagementCommand](/documentation/devicemanagement/declarativemanagementcommand) to the device through the usual MDM command processing flow. This command serves two purposes:
...
3. The service responds with a [DeclarativeManagementCommand](/documentation/devicemanagement/declarativemanagementcommand) that should include the [SynchronizationTokens](/documentation/devicemanagement/synchronizationtokens) JSON data.
