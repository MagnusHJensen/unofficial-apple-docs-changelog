...
- **Type:** `SafariSettingsWebsiteDictionaryObject`
- **Required:** No
...
- [SafariSettingsWebsiteDictionaryObject](/documentation/devicemanagement/safarisettingswebsitedictionaryobject) - The dictionary that defines the website privacy permission defaults. Each key represents a website.
