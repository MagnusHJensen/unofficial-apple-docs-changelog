...
- **Type:** `[NetworkDNSSettingsOnDemandRulesElement_ActionParameterObject]`
- **Required:** No
...
- [NetworkDNSSettingsOnDemandRulesElement_ActionParameterObject](/documentation/devicemanagement/networkdnssettingsondemandruleselement_actionparameterobject) - A dictionary that provides per-connection rules.
