...
- The device-generated bypass code. The server retains this code until it receives a different, nonempty code from the device. For more information, see the [Activation Lock Bypass Code](/documentation/devicemanagement/activation-lock-bypass-code-command) query.
