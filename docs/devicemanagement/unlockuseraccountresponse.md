...
- **Type:** `[UnlockUserAccountResponse.ErrorChainItem]`
- **Required:** No
...
- [UnlockUserAccountResponse.ErrorChainItem](/documentation/devicemanagement/unlockuseraccountresponse/errorchainitem) - A dictionary that describes an error chain item.
