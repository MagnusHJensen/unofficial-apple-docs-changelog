...
- **Type:** `[CancelEnhancedLogCollectionResponse.ErrorChainItem]`
- **Required:** No
...
- [CancelEnhancedLogCollectionResponse.ErrorChainItem](/documentation/devicemanagement/cancelenhancedlogcollectionresponse/errorchainitem) - A dictionary that describes an error chain item.
