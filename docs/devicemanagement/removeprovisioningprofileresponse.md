...
- **Type:** `[RemoveProvisioningProfileResponse.ErrorChainItem]`
- **Required:** No
...
- [RemoveProvisioningProfileResponse.ErrorChainItem](/documentation/devicemanagement/removeprovisioningprofileresponse/errorchainitem) - A dictionary that describes an error chain item.
