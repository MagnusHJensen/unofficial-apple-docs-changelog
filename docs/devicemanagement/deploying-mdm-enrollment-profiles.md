...
See [Install Profile](/documentation/devicemanagement/install-profile-command) for additional information.
...
MDM vendors can take advantage of web services that DEP provides to integrate its features with their services. For more information, see [Simplifying MDM Server Administration for iOS Devices](/documentation/devicemanagement/simplifying-mdm-server-administration-for-ios-devices).
