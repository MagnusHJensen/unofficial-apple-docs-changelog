...
- [ApplyRedemptionCodeCommand](/documentation/devicemanagement/applyredemptioncodecommand) - The command to complete the installation of an app using a redemption code.
- [ApplyRedemptionCodeResponse](/documentation/devicemanagement/applyredemptioncoderesponse) - A response from the device after it processes the command to complete the installation of an app using a redemption code.
