...
- **Type:** `NetworkVPNAlwaysOnProxies_ProtocolObject`
- **Required:** No
...
- [NetworkVPNAlwaysOnProxies_ProtocolObject](/documentation/devicemanagement/networkvpnalwaysonproxies_protocolobject) - The dictionary to use to configure HTTP servers  for `Proxies` for use with `VPN`.
