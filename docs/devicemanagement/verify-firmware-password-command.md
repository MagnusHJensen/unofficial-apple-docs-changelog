...
- [VerifyFirmwarePasswordCommand](/documentation/devicemanagement/verifyfirmwarepasswordcommand) - The command to verify the firmware password on a device.
- [VerifyFirmwarePasswordResponse](/documentation/devicemanagement/verifyfirmwarepasswordresponse) - A response from the device after it processes the command to verify the firmware password on a device.
