...
A string uniquely identifying this declaration. The size of this string shouldn’t exceed 64 octets. A UUID string value is a good choice.

### Payload

- **Type:** `DeclarationBase.Payload`
- **Required:** Yes
...
A unique token generated by the server specifying a particular revision of the declaration. The size of this string shouldn’t exceed 64 octets.
