...
- [AccountGoogle](/documentation/devicemanagement/accountgoogle) - The declaration to configure a Google account.
- [AccountLDAP](/documentation/devicemanagement/accountldap) - The declaration to configure a Lightweight Directory Access Protocol (LDAP) account.
...
- [SafariSettings](/documentation/devicemanagement/safarisettings) - The declaration to configure Safari settings.
...
- [ActivationSimple](/documentation/devicemanagement/activationsimple) - The declaration to activate a set of configurations.
...
- [AssetData](/documentation/devicemanagement/assetdata) - A reference to arbitrary data with a specific media type.
- [AssetUserIdentity](/documentation/devicemanagement/assetuseridentity) - The user-identity data.

### Credentials

- [ACMECredential](/documentation/devicemanagement/acmecredential) - An ACME identity that the device generates.
- [IdentityCredential](/documentation/devicemanagement/identitycredential) - The data for a PKCS #12 password-protected identity.
- [SCEPCredential](/documentation/devicemanagement/scepcredential) - A SCEP identity that the device generates.
- [UserNameAndPasswordCredential](/documentation/devicemanagement/usernameandpasswordcredential) - Data that describes a credential that represents a user name and password.

### Management

- [ManagementOrganizationInformation](/documentation/devicemanagement/managementorganizationinformation) - The declaration to configure the managing organization’s contact information.
