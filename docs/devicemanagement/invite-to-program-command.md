...
- [InviteToProgramCommand](/documentation/devicemanagement/invitetoprogramcommand) - The command to invite a user to join the Volume Purchase Program (VPP).
- [InviteToProgramResponse](/documentation/devicemanagement/invitetoprogramresponse) - A response from the device after it processes the command to invite a user to join the Volume Purchase Program (VPP).
